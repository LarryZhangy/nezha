...
# TODO(jkoelker) When migrate 0.7.3 is released and nezha depends
...
def db_sync(version=None):
    if version is not None:
        try:
            ...
            raise exception.NezhaException(_("version should be an integer"))
...
def db_version():
    ...
    try:
        ...
        if len(tables) == 0:
            ...
            raise exception.NezhaException(
