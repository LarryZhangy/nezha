...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/nezha/sqlite.db",
        sqlite_db="/var/lib/nezha/sqlite.db")
...
from nezha.openstack.common.db import exception
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside nezha
            index = file.rfind('nezha')
            if index == -1:
                continue
